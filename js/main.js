...
var configs = (function () {
    ...
    Singleton.defaultOptions = {
        ...
        welcome: "Merry XXXmas Michael! <3\nI'm sorry that I wasn't able to give this present to you before xmas.\nInstead of a card, I've made this (using pre-existing code)\nHere is my heart:\n♡\nIn order to access the next part, you can execute the 'help' command or use the sidebar nav.",
...
var files = (function () {
    ...
    Singleton.defaultOptions = {
        "HowTo.txt": "This book is by one of my favorite nerds.\nHe's an ex NASA dude that makes webcomics called xkcd.\nThe subject matter of the comic varies from statements on life and love to mathematical, programming, and scientific in-jokes.(taken from Wiki)\nYou ask a lot of questions so I thought this book is perfect for you.",
        ...
        "FavSong.txt": "https://www.youtube.com/watch?v=yXQViqx6GMY",
